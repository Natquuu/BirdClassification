...
class GMM:
    ...
    ----------
        ...
        Attributes
        ----------
        weights_ : weights of each mixture components. Array-like of shape (n_components,)

        means_ : mean of each mixture component. Array-like of shape (n_components, n_features)

        covariances_ : covariance of each mixture component. Array-like of shape (n_components, n_features)

        precisions_ : precision matrices for each component in the mixture. A precision
        ...
        converged_ : when convergence was reached in fit() is True, otherwise False.

        n_iter_ : number of step used by the best fit of EM to reach the convergence.

        lower_bound_ : lower bound value on the log-likelihood (of the training data with
    ...
    def _initialize(self, X, resp):
        ...
        weights, means, covariances = _estimate_gaussian_parameters(X, resp)
        weights /= n_samples
